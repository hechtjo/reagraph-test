...
import { useRef, useCallback, useMemo, useState, useEffect, useLayoutEffect, createContext as createContext$1, useContext, forwardRef, useImperativeHandle, Fragment as Fragment$1, Suspense } from "react";
import { useThree, extend, useFrame, Canvas } from "@react-three/fiber";
import { forceRadial as forceRadial$1, forceSimulation, forceX, forceY, forceCollide, forceManyBody, forceLink, forceZ } from "d3-force-3d";
...
function forceInABox() {
  ...
  let id = index, nodes = [], links = [], tree2, size = [100, 100], forceNodeSize = constant(1), forceCharge = constant(-1), forceLinkDistance = constant(100), forceLinkStrength = constant(0.1), foci = {}, linkStrengthIntraCluster = 0.1, linkStrengthInterCluster = 1e-3, templateNodes = [], offset = [0, 0], templateForce, groupBy = (d) => d.cluster, template = "treemap", enableGrouping = true, strength = 0.1;
...
function forceDirected({
  ...
  const sim = forceSimulation().force("link", forceLink()).force("charge", forceManyBody().strength(nodeStrengthAdjustment)).force("x", forceX(1200 / 2).strength(0.05)).force("y", forceY(1200 / 2).strength(0.05)).force("z", forceZ()).force(
    "collide",
...
function hierarchical({
  ...
  const treeRoot = tree().separation(() => 1).nodeSize([50, 50])(hierarchy(root));
...
function getCurve(from, fromOffset, to, toOffset, curved) {
  ...
  return curved ? new QuadraticBezierCurve3(...getCurvePoints(offsetFrom, offsetTo)) : new LineCurve3(offsetFrom, offsetTo);
}
...
const Sphere = ({
  ...
  const normalizedColor = useMemo(() => new Color(color), [color]);
  return /* @__PURE__ */ jsxs(a.mesh, { userData: { id, type: "node" }, scale, children: [
...
const Ring = ({ color, size, opacity, animated }) => {
  ...
  return /* @__PURE__ */ jsx(Billboard, { position: [0, 0, 1], children: /* @__PURE__ */ jsxs(a.mesh, { scale: ringSize, children: [
    /* @__PURE__ */ jsx("ringGeometry", { attach: "geometry", args: [4, 4.5, 25] }),
    /* @__PURE__ */ jsx(
      a.meshBasicMaterial,
      {
        attach: "material",
  ...
  return /* @__PURE__ */ jsxs(
    a.group,
    {
      ...
      children: [
        ...
        (labelVisible || isSelected || active) && label && /* @__PURE__ */ jsxs(Fragment, { children: [
...
const Edge$1 = ({
  ...
  return /* @__PURE__ */ jsxs("group", { children: [
    ...
    labelVisible && label && /* @__PURE__ */ jsx(a.group, { position: labelPosition, rotation: labelRotation, children: /* @__PURE__ */ jsx(
      Label,
      {
        text: label,
        ellipsis: 15,
    ...
    menuVisible && contextMenu && /* @__PURE__ */ jsx(Html, { prepend: true, center: true, children: contextMenu({ data: edge, onClose: () => setMenuVisible(false) }) })
  ] });
};
Edge$1.defaultProps = {
...
const Cluster = ({
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: theme.cluster && /* @__PURE__ */ jsxs(
    a.group,
    {
      ...
      children: [
        ...
        ((_d = theme.cluster) == null ? void 0 : _d.label) && /* @__PURE__ */ jsx(a.group, { position: labelPosition, children: /* @__PURE__ */ jsx(
          Label,
          {
            text: label,
            opacity,
...
const GraphScene = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsx(Fragment$1, { children: mounted && /* @__PURE__ */ jsxs(Fragment$1, { children: [
      nodeIds.map((n) => /* @__PURE__ */ jsx(
        Node,
        {
          id: n,
          labelFontUrl,
      ...
      animated ? edgeIds.map((e) => /* @__PURE__ */ jsx(
        Edge$1,
        {
          id: e,
          disabled: disabled2,
      ...
      Canvas,
      {
        ...
        children: /* @__PURE__ */ jsxs(
          Provider,
          {
            ...
            children: [
              /* @__PURE__ */ jsx("color", { attach: "background", args: [theme.canvas.background] }),
...
export {
  ...
  GraphScene,
  Icon,
  LABEL_FONT_SIZE$1 as LABEL_FONT_SIZE,
  Label,
  Lasso,
  Line,
  Node,
