...
(function(global, factory) {
  ...
  function forceInABox() {
    ...
    let id = index, nodes = [], links = [], tree, size = [100, 100], forceNodeSize = constant(1), forceCharge = constant(-1), forceLinkDistance = constant(100), forceLinkStrength = constant(0.1), foci = {}, linkStrengthIntraCluster = 0.1, linkStrengthInterCluster = 1e-3, templateNodes = [], offset = [0, 0], templateForce, groupBy = (d) => d.cluster, template = "treemap", enableGrouping = true, strength = 0.1;
  ...
  function forceDirected({
    ...
    const sim = d3Force3d.forceSimulation().force("link", d3Force3d.forceLink()).force("charge", d3Force3d.forceManyBody().strength(nodeStrengthAdjustment)).force("x", d3Force3d.forceX(1200 / 2).strength(0.05)).force("y", d3Force3d.forceY(1200 / 2).strength(0.05)).force("z", d3Force3d.forceZ()).force(
      "collide",
      d3Force3d.forceCollide((d) => d.radius)
    ).force(
      "dagRadial",
      forceRadial({
        nodes,
    ...
    let groupingForce;
    if (clusterAttribute) {
      groupingForce = forceInABox().strength(clusterStrength).template(clusterType).groupBy((d) => d.data[clusterAttribute]).links(edges).size([100, 100]).linkStrengthInterCluster(linkStrengthInterCluster).linkStrengthIntraCluster(linkStrengthIntraCluster).forceLinkDistance(forceLinkDistance).forceLinkStrength(forceLinkStrength).forceCharge(forceCharge).forceNodeSize((d) => d.radius);
    }
  ...
  function hierarchical({
    ...
    const treeRoot = d3Hierarchy.tree().separation(() => 1).nodeSize([50, 50])(d3Hierarchy.hierarchy(root));
  ...
  function calcLabelVisibility(nodeCount, type) {
    return (shape, size) => {
      if (type === "all") {
        return true;
  ...
  function getCurve(from, fromOffset, to, toOffset, curved) {
    const offsetFrom = getPointBetween(from, to, fromOffset);
    const offsetTo = getPointBetween(to, from, toOffset);
    return curved ? new three.QuadraticBezierCurve3(...getCurvePoints(offsetFrom, offsetTo)) : new three.LineCurve3(offsetFrom, offsetTo);
  }
  ...
  const useGraph = ({
    ...
    const { visibleEdges, visibleNodes } = react.useMemo(() => {
      const { visibleEdges: visibleEdges2, visibleNodes: visibleNodes2 } = getVisibleEntities({
        collapsedIds: stateCollapsedNodeIds,
        nodes,
        edges
      });
      return {
        visibleEdges: visibleEdges2,
  ...
  const Sphere = ({
    ...
    const normalizedColor = react.useMemo(() => new three.Color(color), [color]);
    return /* @__PURE__ */ jsxRuntime.jsxs(three$1.a.mesh, { userData: { id, type: "node" }, scale, children: [
  ...
  const Ring = ({ color, size, opacity, animated }) => {
    const normalizedColor = react.useMemo(() => new three.Color(color), [color]);
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(drei.Billboard, { position: [0, 0, 1], children: /* @__PURE__ */ jsxRuntime.jsxs(three$1.a.mesh, { scale: ringSize, children: [
      /* @__PURE__ */ jsxRuntime.jsx("ringGeometry", { attach: "geometry", args: [4, 4.5, 25] }),
      /* @__PURE__ */ jsxRuntime.jsx(
  ...
  const CameraControls = react.forwardRef(
    ({ mode, children, animated, disabled: disabled2 }, ref) => {
  ...
  const useCenterGraph = ({
    ...
    const centerPadding = react.useMemo(() => {
      const { maxX, maxY } = getLayoutCenter(nodes);
      return Math.max(maxX, maxY);
    }, [nodes]);
    const centerNodes = react.useCallback(
      (centerNodes2, padding = PADDING, fill = false) => {
        const { minX, maxX, minY, maxY, minZ, maxZ } = getLayoutCenter(centerNodes2);
        controls == null ? void 0 : controls.fitToBox(
    ...
    react.useLayoutEffect(() => {
      if (controls && (nodes == null ? void 0 : nodes.length) && !mounted.current) {
        centerNodes(nodes);
  ...
  const Node = ({
    ...
    const { pointerOver, pointerOut } = useHoverIntent({
      ...
      onPointerOver: () => {
        setActive(true);
        onPointerOver == null ? void 0 : onPointerOver(node);
      },
      onPointerOut: () => {
        setActive(false);
        onPointerOut == null ? void 0 : onPointerOut(node);
      }
    });
    return /* @__PURE__ */ jsxRuntime.jsxs(
      three$1.a.group,
      {
        ...
        onDoubleClick: () => {
          if (!disabled2 && !isDragging) {
            onDoubleClick == null ? void 0 : onDoubleClick(node);
          }
        },
        onContextMenu: () => {
          if (!disabled2) {
        ...
        children: [
          ...
          (labelVisible || isSelected || active) && label && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
            ...
            subLabel && /* @__PURE__ */ jsxRuntime.jsx(three$1.a.group, { position: subLabelPosition, children: /* @__PURE__ */ jsxRuntime.jsx(
              Label,
              {
                ...
                fontSize: 5,
                opacity: selectionOpacity,
                stroke: (_a2 = theme.node.subLabel) == null ? void 0 : _a2.stroke,
                active: isSelected || active || isDragging || isActive,
                color: isSelected || active || isDragging || isActive ? (_b2 = theme.node.subLabel) == null ? void 0 : _b2.activeColor : (_c = theme.node.subLabel) == null ? void 0 : _c.color
              }
            ) })
          ] })
        ]
    ...
    three$1.useSpring(() => {
      ...
      return {
        ...
        onChange: (event) => {
          ...
          const curve2 = getCurve(fromVector, 0, toVector, 0, curved);
  ...
  const Edge$1 = ({
    ...
    const [active, setActive] = react.useState(false);
    const [menuVisible, setMenuVisible] = react.useState(false);
    const labelOffset = (size + LABEL_FONT_SIZE$1) / 2;
    ...
    const [curve, arrowPosition, arrowRotation] = react.useMemo(() => {
      ...
      let curve2 = getCurve(fromVector, fromOffset, toVector, toOffset, curved);
      ...
      if (arrowPlacement === "end") {
        curve2 = getCurve(fromVector, fromOffset, arrowPosition2, 0, curved);
      }
    ...
    const { pointerOver, pointerOut } = useHoverIntent({
      ...
      onPointerOver: () => {
        setActive(true);
        onPointerOver == null ? void 0 : onPointerOver(edge);
      },
      onPointerOut: () => {
        setActive(false);
        onPointerOut == null ? void 0 : onPointerOut(edge);
      }
    });
    return /* @__PURE__ */ jsxRuntime.jsxs("group", { children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        Line,
        {
          ...
          onClick: () => {
            if (!disabled2) {
              onClick == null ? void 0 : onClick(edge);
            }
          },
          onPointerOver: pointerOver,
          onPointerOut: pointerOut,
      ...
      labelVisible && label && /* @__PURE__ */ jsxRuntime.jsx(three$1.a.group, { position: labelPosition, rotation: labelRotation, children: /* @__PURE__ */ jsxRuntime.jsx(
        Label,
        {
          text: label,
          ellipsis: 15,
      ...
      menuVisible && contextMenu && /* @__PURE__ */ jsxRuntime.jsx(drei.Html, { prepend: true, center: true, children: contextMenu({ data: edge, onClose: () => setMenuVisible(false) }) })
    ] });
  };
  Edge$1.defaultProps = {
    ...
    const getGeometries = react.useCallback(
      (edges) => {
        ...
        edges.forEach((edge) => {
          ...
          const fromVector = getVector(from);
          const fromOffset = from.size + LABEL_FONT_SIZE$1;
          const toVector = getVector(to);
          const toOffset = to.size + LABEL_FONT_SIZE$1;
          let curve = getCurve(
            fromVector,
            fromOffset,
            toVector,
  ...
  const Cluster = ({
    ...
    const normalizedStroke = react.useMemo(
      ...
      [(_a2 = theme.cluster) == null ? void 0 : _a2.stroke]
    );
    const normalizedFill = react.useMemo(
      ...
      [(_b2 = theme.cluster) == null ? void 0 : _b2.fill]
    );
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: theme.cluster && /* @__PURE__ */ jsxRuntime.jsxs(
      three$1.a.group,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsxs("mesh", { children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx(
              three$1.a.meshBasicMaterial,
              {
                ...
                transparent: true,
                depthTest: false,
                opacity: ((_c = theme.cluster) == null ? void 0 : _c.fill) ? circleOpacity : 0,
                side: three.DoubleSide,
                fog: true
              }
            )
          ...
          ((_d = theme.cluster) == null ? void 0 : _d.label) && /* @__PURE__ */ jsxRuntime.jsx(three$1.a.group, { position: labelPosition, children: /* @__PURE__ */ jsxRuntime.jsx(
            Label,
            {
              text: label,
              opacity,
  ...
  const GraphScene = react.forwardRef(
    ({
      ...
      const edgeIds = react.useMemo(() => edges.map((e) => e.id), [edges]);
      ...
      return /* @__PURE__ */ jsxRuntime.jsx(react.Fragment, { children: mounted && /* @__PURE__ */ jsxRuntime.jsxs(react.Fragment, { children: [
        nodeIds.map((n) => /* @__PURE__ */ jsxRuntime.jsx(
          Node,
          {
            id: n,
            labelFontUrl,
        ...
        animated ? edgeIds.map((e) => /* @__PURE__ */ jsxRuntime.jsx(
          Edge$1,
          {
            id: e,
            disabled: disabled2,
    ...
    const onNodeClick = react.useCallback(
      (data) => {
        ...
        if (focusOnSelect === true || focusOnSelect === "singleOnly" && !metaKeyDown) {
          ...
          (_a2 = ref.current) == null ? void 0 : _a2.centerGraph([data.id, ...adjacents]);
        }
      },
      [
        addSelection,
      ...
      (event) => {
        ...
        if (event.button !== 2 && (internalSelections.length || internalActives.length)) {
          ...
          if (focusOnSelect && internalSelections.length === 1) {
            ...
            (_a2 = ref.current) == null ? void 0 : _a2.centerGraph();
          }
        }
      },
      [
  ...
  const GraphCanvas = react.forwardRef(
    ({
      ...
      react.useImperativeHandle(ref, () => ({
        centerGraph: (n) => {
          var _a2;
          return (_a2 = rendererRef.current) == null ? void 0 : _a2.centerGraph(n);
        },
        zoomIn: () => {
          var _a2;
          return (_a2 = controlsRef.current) == null ? void 0 : _a2.zoomIn();
        },
        zoomOut: () => {
          var _a2;
          return (_a2 = controlsRef.current) == null ? void 0 : _a2.zoomOut();
        },
        panLeft: () => {
          var _a2;
          return (_a2 = controlsRef.current) == null ? void 0 : _a2.panLeft();
        },
        panRight: () => {
          var _a2;
          return (_a2 = controlsRef.current) == null ? void 0 : _a2.panRight();
        },
        panDown: () => {
          var _a2;
          return (_a2 = controlsRef.current) == null ? void 0 : _a2.panDown();
        },
        panUp: () => {
          var _a2;
          return (_a2 = controlsRef.current) == null ? void 0 : _a2.panUp();
        },
        resetControls: (animated2) => {
          var _a2;
          return (_a2 = controlsRef.current) == null ? void 0 : _a2.resetControls(animated2);
        },
        getControls: () => {
          var _a2;
          return (_a2 = controlsRef.current) == null ? void 0 : _a2.controls;
        },
        getGraph: () => {
          var _a2;
          return (_a2 = rendererRef.current) == null ? void 0 : _a2.graph;
        }
      }));
        ...
        fiber.Canvas,
        {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsxs(
            Provider,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntime.jsx("color", { attach: "background", args: [theme.canvas.background] }),
  ...
  exports2.Icon = Icon;
  exports2.LABEL_FONT_SIZE = LABEL_FONT_SIZE$1;
